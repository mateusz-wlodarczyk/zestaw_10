...
import SingleNavbar from './SingleNavLink';
...
export default function Navbar() {
  return (
    <Flex gap='40px' flexDirection='column' alignItems='center' sx={boxSxStyle}>
      <SingleNavLink link={ROUTES.home.link} text={ROUTES.home.text} icon={ROUTES.home.icon} />
      <Box>
        <SingleNavLink link={ROUTES.visit.link} text={ROUTES.visit.text} icon={ROUTES.visit.icon} />
        <SingleNavbar
